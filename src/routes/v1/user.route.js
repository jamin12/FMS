...
const { userValidation, uploadValidation } = require('../../validations');
...
router
  .route('/my-info')
  .get(auth(), myInfoController.getUser)
  .patch(auth(), validate(userValidation.updateUser), myInfoController.updateUser);
